...
async def seed_majors(db: AsyncSession) -> Dict:
    """Seed majors"""
    majors_data = [
        {"code": "C", "name": "Computer Science", "degree_type": "Bachelor", "credits_required": 360,
         "description": "Software development, algorithms, and computing systems"},
        {"code": "B", "name": "Business Administration", "degree_type": "Bachelor", "credits_required": 360,
         "description": "Management, finance, and business operations"},
        {"code": "D", "name": "Graphic Design", "degree_type": "Bachelor", "credits_required": 360,
         "description": "Visual communication and digital media"},
        {"code": "IT", "name": "Information Technology", "degree_type": "Bachelor", "credits_required": 360,
         "description": "IT infrastructure, networks, and systems administration"},
        {"code": "MK", "name": "Marketing", "degree_type": "Bachelor", "credits_required": 360,
...
async def seed_users(db: AsyncSession) -> Dict:
    ...
    users_data = [
        {"username": "admin", "email": "admin@greenwich.edu.vn", "full_name": "System Administrator",
         "hashed_password": SecurityUtils.get_password_hash("admin123"), "role": "admin", "status": "active",
         "campus_id": campus_map.get("D"), "phone_number": "+84 236 3525 688", "is_active": True},
        {"username": "nguyen.van.a", "email": "nguyen.van.a@greenwich.edu.vn", "full_name": "Nguyen Van A",
         "hashed_password": SecurityUtils.get_password_hash("teacher123"), "role": "teacher", "status": "active",
         "campus_id": campus_map.get("H"), "major_id": major_map.get("C"), "phone_number": "+84 98 765 4321",
         "date_of_birth": date(1985, 5, 15), "gender": "male", "is_active": True},
        {"username": "tran.thi.b", "email": "tran.thi.b@greenwich.edu.vn", "full_name": "Tran Thi B",
         "hashed_password": SecurityUtils.get_password_hash("teacher123"), "role": "teacher", "status": "active",
         "campus_id": campus_map.get("D"), "major_id": major_map.get("B"), "phone_number": "+84 97 654 3210",
         "date_of_birth": date(1987, 8, 20), "gender": "female", "is_active": True},
        {"username": "gch210001", "email": "gch210001@greenwich.edu.vn", "full_name": "Le Van C",
         "hashed_password": SecurityUtils.get_password_hash("student123"), "role": "student", "status": "active",
         "campus_id": campus_map.get("H"), "major_id": major_map.get("C"), "phone_number": "+84 96 543 2109",
         "date_of_birth": date(2003, 3, 10), "gender": "male", "year_entered": 2021, "is_active": True},
        {"username": "gcd220002", "email": "gcd220002@greenwich.edu.vn", "full_name": "Pham Thi D",
         "hashed_password": SecurityUtils.get_password_hash("student123"), "role": "student", "status": "active",
         "campus_id": campus_map.get("D"), "major_id": major_map.get("D"), "phone_number": "+84 95 432 1098",
         "date_of_birth": date(2004, 7, 25), "gender": "female", "year_entered": 2022, "is_active": True},
        {"username": "gcb230003", "email": "gcb230003@greenwich.edu.vn", "full_name": "Hoang Van E",
         "hashed_password": SecurityUtils.get_password_hash("student123"), "role": "student", "status": "active",
         "campus_id": campus_map.get("C"), "major_id": major_map.get("B"), "phone_number": "+84 94 321 0987",
         "date_of_birth": date(2005, 11, 5), "gender": "male", "year_entered": 2023, "is_active": True},
    ]
...
async def seed_courses(db: AsyncSession) -> Dict:
    ...
    courses_data = [
        {"course_code": "COMP1640", "name": "Enterprise Web Software Development", "credits": 15,
         ...
         "description": "Full-stack web development with modern frameworks", "is_active": True},
        {"course_code": "COMP1841", "name": "Database Development and Design", "credits": 15,
         "major_id": major_map.get("C"), "level": 1,
         "description": "Relational database design and SQL", "is_active": True},
        {"course_code": "COMP1649", "name": "Data Structures & Algorithms", "credits": 15,
         "major_id": major_map.get("C"), "level": 1,
         "description": "Core algorithms and data structure implementations", "is_active": True},
        {"course_code": "BUS1101", "name": "Introduction to Business", "credits": 15,
         "major_id": major_map.get("B"), "level": 1,
         "description": "Fundamentals of business operations", "is_active": True},
        {"course_code": "MKT2201", "name": "Marketing Management", "credits": 15,
         "major_id": major_map.get("B"), "level": 2,
         "description": "Strategic marketing planning and execution", "is_active": True},
        {"course_code": "DES1301", "name": "Design Fundamentals", "credits": 15,
         "major_id": major_map.get("D"), "level": 1,
         "description": "Principles of visual design", "is_active": True},
    ]
