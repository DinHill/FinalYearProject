...
async def seed_users(db: AsyncSession) -> Dict:
    ...
    users_data = [
        {"username": "admin", "email": "admin@greenwich.edu.vn", "full_name": "System Administrator",
         "hashed_password": SecurityUtils.hash_password("admin123"), "role": "admin", "status": "active",
        ...
        {"username": "nguyen.van.a", "email": "nguyen.van.a@greenwich.edu.vn", "full_name": "Nguyen Van A",
         "hashed_password": SecurityUtils.hash_password("teacher123"), "role": "teacher", "status": "active",
        ...
        {"username": "gch210001", "email": "gch210001@greenwich.edu.vn", "full_name": "Le Van C",
         "hashed_password": SecurityUtils.hash_password("student123"), "role": "student", "status": "active",
